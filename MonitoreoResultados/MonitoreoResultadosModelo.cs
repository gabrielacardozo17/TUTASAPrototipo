                ...
                .Select(empresa =>
                {
                    ...
                    if (costo == 0m)
                    {
                        ...
                        if (empresa.PrecioPorBodegaFijoPorMes != null && empresa.PrecioPorBodegaFijoPorMes.Any())
                        {
                            ...
                            defaultCosto = (decimal)avg / 4m; 
                        }
                        if (defaultCosto <= 0m) defaultCosto = 300000m; 
                    ...
                    // si no hay HDRs pero GuiaAlmacen contiene guías, usar esos importes
