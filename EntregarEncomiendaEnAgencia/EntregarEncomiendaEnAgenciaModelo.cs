    ...
    public class EntregarEncomiendaEnAgenciaModelo
    {
        ...
        private void InicializarDatos()
        {
            ...
            Guias = new List<Guia>
            {
                ...
                new Guia { NumeroGuia = "004000210", Tamanio = Tamanio.S, DniDestinatario = "25876543", Estado = "En CD destino", Ubicacion = "CD 0050" },
                ...
                new Guia { NumeroGuia = "017000021", Tamanio = Tamanio.M, DniDestinatario = "25876543", Estado = "En CD destino", Ubicacion = "CD 0070" },
                ...
                new Guia { NumeroGuia = "104400022", Tamanio = Tamanio.S, DniDestinatario = "35123456", Estado = "En CD destino", Ubicacion = "CD 0040" },
                ...
                new Guia { NumeroGuia = "107400025", Tamanio = Tamanio.XL, DniDestinatario = "28765432", Estado = "En CD destino", Ubicacion = "CD 0070" },
        ...
        {
            var estadosValidos = new List<string> { "En agencia destino", "En espera de retiro en agencia", "Pendiente de entrega" };
            return Guias.Where(g => g.DniDestinatario == dni && estadosValidos.Contains(g.Estado) && g.Ubicacion == agenciaActual).ToList();
        }
